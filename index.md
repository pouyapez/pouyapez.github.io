      ...
      <tr>
        ...
        <td>
          <p class="text right-align text-large add-top-margin" style="width:100%;">
             <font style="color:firebrick;"><b>I am on the job market!</b></font> I am a fifth-year PhD student in Machine Learning at the University of California Irvine, advised by Prof.                       <a href="http://sameersingh.org">Sameer Singh</a>. My main area of interest are Knowledge Graph Completion, Interpretability, Active Learning and Text Generation. 
          </p>
        </td>
      </tr>
   </table>
