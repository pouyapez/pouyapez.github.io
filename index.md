...
<div class="menu-container noselect">
   <table class="content-table">
      <tr>
        <td>
          <img class="left-align image noselect" src="/images/crowd.jpg">
        </td>
        <td>
          <p class="text right-align text-large add-top-margin" style="width:100%;">
...
<div class="menu-container noselect">
   <table class="content-table">
      <tr>
        <td>
          <img class="left-align image noselect" src="/images/criage.png">
        </td>
        <td>
          <p class="text right-align text-large add-top-margin" style="width:100%;">
...
<div class="menu-container noselect">
   <table class="content-table">
      <tr>
        <td>
          <img class="left-align image noselect" src="/images/2014.png"  width="2000">
        </td>
        <td>
          <p class="text right-align text-large add-top-margin" style="width:100%;">
