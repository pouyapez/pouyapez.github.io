      ...
      <tr>
        ...
        <td>
          <p class="text cright-align text-large add-top-margin" style="width:100%;" align="center">
             ...
             </p><p align="justify"> <font style="font-size:13px">In this paper we explicitly characterizes the extremal GDoF gain of optimal over binary power control as Θ(&radic;<span style="text-decoration: overline">k</span>) for all 𝐾. In particular, the extremal gain is bounded between b
