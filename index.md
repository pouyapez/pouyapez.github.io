   ...
   <table class="content-table">
    ...
    <col width="800px" />
      <tr>
        ...
        <td>
          <p class="text cright-align text-large add-top-margin" style="width:100%;" align=“justify”>
   ...
   <table class="content-table">
    ...
    <col width="800px" />
      <tr>
        ...
        <td>
          <p class="text right-align text-large add-top-margin" style="width:100%;" align=“justify”>
   ...
   <table class="content-table">
    ...
    <col width="800px" />
      <tr>
        ...
        <td>
          <p class="text right-align text-large add-top-margin" align=“justify”>
